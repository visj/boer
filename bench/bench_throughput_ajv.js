...
fs.writeFileSync('heap_baseline_ajv.json', JSON.stringify(baseline, null, 2));
...
const compile = getHeapStatistics();

fs.writeFileSync('heap_compile_ajv.json', JSON.stringify(compile, null, 2));
...
console.log("Ajv count: ", counter);

const val = getHeapStatistics();
fs.writeFileSync('heap_validate_ajv.json', JSON.stringify(val, null, 2));
